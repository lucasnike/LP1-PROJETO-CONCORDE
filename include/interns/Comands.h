...
const vector<string> COMANDOS_SALVAR = {"create-user", "create-server", "set-server-desc", "set-server-invite-code",
                                        "remove-server", "create-channel", "send-message", "enter-server"};